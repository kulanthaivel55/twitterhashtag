...
import com.example.twitterhashtagsearch.adapters.TweetListAdapter;
import com.example.twitterhashtagsearch.models.Tweet;
import com.example.twitterhashtagsearch.models.TweetDateFormatter;
import com.example.twitterhashtagsearch.repository.RepositoryCallback;
import com.example.twitterhashtagsearch.repository.TwitterRepository;

import java.util.ArrayList;
import java.util.List;

public class SearchFragment extends Fragment implements TweetListAdapter.AppCallback {
    ...
    private void setupTweetListView() {
        mAdapter = new TweetListAdapter(getContext(), new TweetDateFormatter(),this);
    ...
    @Override
    public void sendSearchDetailsScreen(String aUrl) {
        Intent aSearchDetailsIndent=new Intent(mContext, TwitterSearchDetails.class);

        aSearchDetailsIndent.putExtra("post_url",aUrl);
        startActivity(aSearchDetailsIndent);
    }
